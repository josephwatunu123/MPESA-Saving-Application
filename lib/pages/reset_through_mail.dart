...
class ResetPassMail extends StatelessWidget{

  const ResetPassMail({Key? key}) : super(key: key);
        ...
        body: Container(
          ...
          child: Column(
            children: [
              ...
              Text("Enter your E-mail",style: const TextStyle(fontSize: 18.0, fontWeight: FontWeight.bold)),
